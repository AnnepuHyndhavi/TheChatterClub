...
<head>
    ...
    <style>
        ...
        .content {
            ...
            box-shadow: 0 0 5px #6e1d55;
        }
    </style>
</head>
<body>
    <h1>Welcome to The Chatter Club</h1>
    <div class="container">
        <div class="tab">
            <button class="tablink active" onclick="openTab(event,'signin')" id="link1">Login</button>
            <button class="tablink" onclick="openTab(event,'signup')" id="link2">Signup</button>
        </div>
        <div class="content">
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()">
                    ...
                    <br>
                    <!--Confirm Email-->
                    <label>Confirm your Email<span>*</span></label><br>
                    <input type="text" name="useremailconfirm" id="useremailconfirm">
                    <div class="required"></div>
                    <br>
                    <!--Birth Date-->
                    ...
                    <input type="text" id="userhometown"  name="userhometown">
                    <br>
                    <!--Package Two-->
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // A form is posted
    ...
    if (isset($_POST['register'])) { // Register process
        ...
        // Checking for Some Unique Constraints
